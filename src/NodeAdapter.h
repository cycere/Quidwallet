...
public:
  ...
  Quid::IWalletLegacy* createWallet() const;
...
private:
  ...
  Quid::CoreConfig makeCoreConfig() const;
  Quid::NetNodeConfig makeNetNodeConfig() const;
...
Q_SIGNALS:
  ...
  void initNodeSignal(Node** _node, const Quid::Currency* currency, INodeCallback* _callback, Logging::LoggerManager* _loggerManager,
