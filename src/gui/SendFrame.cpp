...
void SendFrame::sendClicked() {
  QVector<Quid::WalletLegacyTransfer> walletTransfers;
  Q_FOREACH (TransferFrame * transfer, m_transfers) {
    ...
    Quid::WalletLegacyTransfer walletTransfer;
...
void SendFrame::sendTransactionCompleted(Quid::TransactionId _id, bool _error, const QString& _errorText) {
  Q_UNUSED(_id);
  if (_error) {
    QCoreApplication::postEvent(
      &MainWindow::instance(),
