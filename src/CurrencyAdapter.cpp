...
CurrencyAdapter::CurrencyAdapter() : m_currency(Quid::CurrencyBuilder(LoggerAdapter::instance().getLoggerManager()).currency()) {
}

CurrencyAdapter::~CurrencyAdapter() {
}

const Quid::Currency& CurrencyAdapter::getCurrency() {
  return m_currency;
}
...
bool CurrencyAdapter::validateAddress(const QString& _address) const {
  Quid::AccountPublicAddress internalAddress;
